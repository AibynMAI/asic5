...
public class ApiMain {
        ...
        server.createContext("/organizers", ex -> {
            ...
            try {
                ...
                if ("POST".equalsIgnoreCase(method)) {
                    ...
                    if (organization.isBlank()) throw new IllegalArgumentException("organization is required");
                ...
                // красивый ответ вместо 500, если email уникальный и уже есть
    ...
    // Очень простой парсер для {"key":"value"} (хватает для твоего проекта сейчас)
